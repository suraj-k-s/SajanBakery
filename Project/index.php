            ...
            <div class="col-lg-4 text-center bg-secondary"  >
                <div class="d-inline-flex align-items-center justify-content-center">
                    <a href="homepage.php" class="navbar-brand">
                        <h1 class="m-0 text-uppercase text-white"><img src="Assets/Files/User/abc.png" width="400" height="120"   alt=""></h1>
                    </a>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="Guest/newuser.php" class="nav-item nav-link">Sign Up</a>
                <a href="Guest/login.php" class="nav-item nav-link">Sign In</a>
...
<div class="container-fluid bg-primary py-5 mb-5 hero-header">
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-uppercase text-white mb-4">Sajan Bakery</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                ...
                <h1 class="display-4 text-uppercase">Welcome To Sajan Bakery</h1>
            </div>
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    <h4 class="mb-4">We established Sajan bakery in 1963 with our shop in chunkkapara</h4>
                    <p class="mb-5"></p>
                    <div class="row g-5">
                        <div class="col-sm-6">
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 col-md-6 text-center">
                    ...
                    <a href="Guest/login.php" class="btn btn-primary border-inner py-3 px-5">Order Now</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">Chunkappara,Kottangal,
                                    Pathanamthitta  </p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">sajanbakery@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
    ...
    <div class="container-fluid text-secondary py-4" style="background: #111111;">
        <div class="container text-center">
            <br><br>
            <p class="mb-0">&copy; <a class="text-white border-bottom" >Sajan Bakery</a>. All Rights Reserved. 
