...
$dname = "";
    ...
    if(isset($_POST['btn_save']))
    {
        ...
        $price = $_POST['txt_price'];
            ...
            $ins = "insert into tbl_category(category_name,category_price) values('".$category."','".$price."')";
                                    ...
                                    <div class="col-lg-12">
                                        <div class="white_box mb_30">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="txt_category">Category Price</label>
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?php echo $data["category_price"];?></td>
